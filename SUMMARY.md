...
* [2.docker镜像](2.docker-image/README.md)
  ...
  * [Dockerfile](2.docker-image/dockerfile/README.md)
    ...
    * [使用 buildx 构建多平台 Docker 镜像](2.docker-image/dockerfile/buildx.md)
    * [不升级内核使用qemu-static构建其他架构镜像](2.docker-image/dockerfile/qemu-static.md)
    * [buildx 妙用](2.docker-image/dockerfile/buildx-magical-effect.md)
    * [特权构建镜像](2.docker-image/dockerfile/privileged-build.md)
